...
client = pymongo.MongoClient("mongodb://masteruser:*****1@******.cluster-ckutjdcz3cie.us-east-1.docdb.amazonaws.com:27017/?replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false")
db = client["insta360"]
media_collection = db["media_1k"]
